...
```{r}
    directory<-"specdata"
    id<-1:332
    threshold = 300 ## Currently unused
    ...
    ##TODO: i am going to cbind and then filter on threshold - this is probably very inelegant - perhaps i am better off creating a ture/flase vector and then using that to filter the data    
    
    
    
    
    
    complete_summary[complete_summary>threshold]
    
    ## Getting a true/false vector and then 'filtering' on that.  
    complete_summary[,"nobs"]>threshold 
    
    complete_data_df[complete_summary[,"nobs"]>threshold]
